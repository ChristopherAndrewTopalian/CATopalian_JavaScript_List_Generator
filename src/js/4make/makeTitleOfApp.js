...
function makeTitleOfApp()
{
    ...
    titleOfApp.textContent = 'CATopalian JavaScript List Generator';
    titleOfApp.href = 'https://github.com/ChristopherAndrewTopalian/CATopalian_JavaScript_List_Generator';
